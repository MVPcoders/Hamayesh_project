# Generated by Django 5.2.1 on 2025-05-18 09:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('land_line', models.CharField(blank=True, max_length=11, null=True, unique=True, verbose_name='تلفن ثابت')),
                ('degree', models.CharField(max_length=300, verbose_name='مدرک تحصیلی')),
                ('Field_of_Study', models.CharField(blank=True, max_length=200, null=True, verbose_name='رشته ی تحصیلی')),
                ('company', models.CharField(blank=True, max_length=200, null=True, verbose_name='شرکت / سازمان')),
